...
public class EditCell<S, T> extends DragSelectionCell<S,T> {
	...
	public void cancelEdit() {
		if (escapePressed) {
			...
			if (textField != null) {
				...
				// we shouldnt be comming here.  textField is null
				// we will put in a blank value
				System.out.println("ERROR - cancel edit issue");
				this.commitEdit(getConverter().fromString(""));
